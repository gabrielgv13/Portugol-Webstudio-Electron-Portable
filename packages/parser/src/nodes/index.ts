import * as Antlr from "@portugol-webstudio/antlr";
import {
    ArquivoContext,
...
export {
    ...
    InteiroExpr, LiteralObjetoExpr, LógicoExpr,
    MaisUnárioExpr,
    MenosUnárioExpr,
    MultiplicaçãoExpr,
    MóduloExpr,
    ...
    RealExpr,
    ReferênciaArrayExpr,
    ReferênciaMatrizExpr, ReferênciaVarExpr,
    RetorneCmd,
    SeCmd,
    SenãoCmd,
    SomaExpr,
...
export const ContextNodeMap = new Map<new (...args: any[]) => ParserRuleContext, new (...args: any[]) => Node>([
  ...
  [(Antlr as any).AcessoPropriedadeContext, AcessoPropriedadeExpr],
  [(Antlr as any).LiteralObjetoContext, LiteralObjetoExpr],
    [(Antlr as any).PropriedadeContext, Propriedade],
